...
export default function LogoBanner({ heroOverlay = false }) {
  return (
    ...
    >
      <div className="pointer-events-auto box-border flex h-full min-w-0 flex-1 items-center py-2 pl-3 pr-2 sm:pl-4 sm:pr-3 lg:w-64 lg:flex-none lg:pl-3 lg:pr-2">
        <a
          href="/"
        ...
        <img
          src="/Logo.png"
          alt="AutoDash logo"
          className="box-border h-full max-h-full w-auto max-w-full object-contain object-left"
        />
        </a>
      </div>
    </div>
