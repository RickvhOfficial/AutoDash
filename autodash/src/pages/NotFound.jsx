...
export default function NotFound() {
  return (
    <div className="flex w-full flex-1 flex-col items-center justify-center px-4 py-10 sm:px-8 sm:py-12 md:py-16">
      <div className="w-full max-w-xl overflow-hidden rounded-xl border border-slate-800 bg-slate-900/60 shadow-lg backdrop-blur-sm">
        <div className="relative h-[clamp(6.5rem,20vw,10.5rem)] w-full shrink-0 border-b border-slate-800">
          <img
            src={FLAG_BANNER_IMG}
            alt="Geblokte finishvlag"
            className="absolute inset-0 h-full w-full object-cover object-[center_42%]"
          />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-slate-900/35" />
        </div>
        <div className="px-8 py-8 text-center sm:px-10 sm:py-10 md:px-12 md:py-12">
          <h1 className="text-[clamp(3.5rem,14vw,7.5rem)] font-bold leading-none tracking-tight text-slate-100">
            404
          </h1>
